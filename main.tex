...
The present work focuses on a specific type of district network, based on CO2 as a working fluid, which allows to exchange heat through condensation and evaporation. The low distribution temperature increases the potential of heat recovery, and thus the energy and exergy efficiency of the global system. Previous studies have shown that very high efficiencies can be reach with the use of heat pumps to supply heat to the buildings, and harvesting heat from lake water. The aim of this work is to study the performance of such a system, based on a case study, the Eglantine district located near Lausanne. Specifically it has been looked at evaluating the integration of a geothermal field, as a heat source. The main research questions that will be tried to answer are:\\
...
%\subsubsection{Ground-sourced CP}
...
%\subsubsection{Lake-sourced CP}
Equations and modeling are the same as for the above described heat pumps. R1234yf HP used


%\input{Tables/cp_source.tex}
\todo{summary table needed here (Ts, dTmin, Tevap, P...)? for cp or for CO2DEN or for Both scenarios???}
...
\todo{what todo with this section?}
