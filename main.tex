...
The present work focuses on a specific type of district network, base on CO2 as a working fluid. Through condensation and evaporation it allows to exchange heat at low temperatures, increasing the potential of heat recovery, and thus the energy and exergy efficiency of the global system. Previous studies have shown that very high efficiencies can be reach with the use of heat pumps to supply heat to the buildings, as well as to harvest heat from environment. The aim of this work is to study the performance of such a system, based on a case study, the Eglantine district located near Lausanne. Specifically it has been looked at evaluating the integration of a geothermal field, as a heat source. The main research questions that will be tried to answer are:\\

\textit{How does the CO2 district energy network perform - energetically as well as financially - in the Eglantine district, harvesting heat from a geothermal field, and under which conditions does it perform better than concurrent solutions?}\\
...
The CO2 network technology has been modeled and analyzed exchanging heat with a geothermal field and the lake water, and it has been compared to a state of the art decentralized geothermal heat pump system. 
The geothermal CO2 network showed a global COP of 6.1 and an exergy efficiency of 22\%, outperforming the other technologies, thanks to the implementation of a direct expansion system of CO2 into the ground. The performance increases even more when an external heat source is integrated.

It has been shown that the CO2 technology performs best in this type of district.
...
The reason for the high performance of the GS-CO2DEN, despite having two stages and thus some additional losses due to $\Delta T_{min}$ values, is the direct expansion of CO2. As shown in Section \todo{ref section}, the energy and exergy gain, with respect to the conventional system based on a secondary water loop, are indeed remarkable.\\
...
\begin{figure}[tph]
	...
	\label{fig:gsco2_el}
\end{figure}
\todo{percentage of elcons reduction between technologies??}
...
\todo{might be other reasons deciding, like space issue...}
...
\todo{still not enough to have lower TC, but better}
...
The response to the ground temperature, i.e. to the depth of the boreholes, has also been analyzed.

The results show that, at the Eglantine conditions, optimum operating costs are found with a purely \textit{retail} district, due to the lower heating demand. However, the higher cooling demand, covered by free-cooling, strongly increases the investment costs for the geothermal wells. The optimum for the total cost, situates thus around 15\% retail and 85\% housing.\\
