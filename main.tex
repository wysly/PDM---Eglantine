...
Given the relevance of the heat pumps in this energy system, it has been chosen to use its thermodynamic model, as described in Section \ref{sss:hp_thermo}, which achieves more reliable and precise results.
